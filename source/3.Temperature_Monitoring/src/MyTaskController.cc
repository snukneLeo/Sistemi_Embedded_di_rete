...
MyTaskController::MyTaskController( const sc_core::sc_module_name modulename,
                	  const task_id_t id,
                      Scnsl::Core::Node_t * n,
...
void MyTaskController::b_transport( tlm::tlm_generic_payload & p, sc_core::sc_time & t )
{
	Payload_t *temp = NULL; 
	bool c;
